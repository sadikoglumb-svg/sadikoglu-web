            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {projeler.map((proje) => (
                <Link
                  ...
                  className="group bg-white border border-gray-100 hover:shadow-lg transition-all duration-200 hover:-translate-y-1 flex flex-col"
                >
                  {/* Renk şerit */}
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <div className="flex items-start justify-between gap-3 mb-4">
                      <h2 className="font-serif text-xl text-navy font-bold group-hover:text-gold transition-colors leading-tight">
                        {proje.ad}
                      </h2>
                      <span
                        className={`shrink-0 text-xs px-2.5 py-1 border rounded-full font-medium ${
                          ASAMA_COLORS[proje.asama] || "bg-gray-100 text-gray-700 border-gray-200"
                        }`}
                      >
                        {proje.asama}
                      </span>
